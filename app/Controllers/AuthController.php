...
class AuthController extends BaseController
{
    ...
    public function postLogin()
    {
       ...
       $user_n =  Input::get('username');
       $pass_w =  Input::get('password'); 
       ...
       if (str_contains($credentials['username'], '@')) {
        ...
        if (Auth::attempt(array('username'=>$credentials['username'],'password'=>$credentials['password']), true)) {
...
{
    $message->to('m.younis@jea.org.jo')->subject(\Lang::get('emails.newCompanyreset'));
});
//////////////////
