...
class TrickRepository extends AbstractRepository implements TrickRepositoryInterface
{
  ...
  /**
    ...
    public function findByCategory($slug, $perPage = 9)
    {
        ...
        $tricks = $category->tricks()->where('trick_status','=',2)->orderBy('created_at', 'DESC')->paginate($perPage);
    ...
    public function create(array $data)
    {
        ...
        $trick->slug        = (rand()*rand());#Str::slug($data['title'], '-');
    ...
    public function findByTag($slug, $perPage = 9)
    {
        ...
        $tricks = $tag->tricks()->where('trick_status','=',2)->orderBy('created_at', 'desc')->paginate($perPage);
