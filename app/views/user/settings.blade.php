      ...
      <div class="content-box">
          ...
          <fieldset>
            <div class="form-group">
              ...
              <div class="col-lg-8">
                {{ Form::text('companyname', Auth::user()->companyname, array('class'=>'form-control','placeholder'=>'إسم الشركة ...'))}}
               </div>
            </div>
             <div class="form-group">
              <label for="phonenumber" class="col-lg-4 control-label">{{ trans('user.phonenumber') }}</label>
              <div class="col-lg-8">
                {{ Form::text('phonenumber', Auth::user()->phonenumber, array('class'=>'form-control','placeholder'=>'رقم هاتف الشركة ....'))}}
              </div>
              </div>
              <div class="form-group">
              <label for="Address" class="col-lg-4 control-label">{{ trans('user.Address') }}</label>
              <div class="col-lg-8">
                {{ Form::text('Address', Auth::user()->Address, array('class'=>'form-control','placeholder'=>'عنوان الشركة ...'))}}
               </div>
               </div>
             ...
             <div class="form-group">
               <label for="flag_name" class="col-lg-4 control-label">{{ trans('home.flag_name') }}</label>
                 <div class="col-lg-8">
                @if(Auth::user()->flag_name==1)
                نعم : {{ Form::radio('flag_name',1,true)."  " }} 
                لا : {{ Form::radio('flag_name',0)."  " }} 
                 @else
                  نعم : {{ Form::radio('flag_name',1)."  " }} 
                لا : {{ Form::radio('flag_name',0,true)."  " }} 
             ...
             <div class="form-group {{Session::get('username_required')? 'has-error': ''}}">
              ...
              <div class="col-lg-8">
                {{ Form::text('username', Auth::user()->username, array('class'=>'form-control','placeholder'=>'إسم المستخدم ...'))}}
